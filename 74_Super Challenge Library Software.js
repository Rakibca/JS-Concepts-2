...
function addBookToCollection(title, author, yearPublished, libraryData) {
  ...
  // Push the book object to 'collection' array
  collection.push({
    title: title,
    author: author,
...
The code above handles information about books in a library
system. This code is functional but can be improved to 
